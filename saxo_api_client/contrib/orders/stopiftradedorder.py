...
class StopIfTradedOrder(BaseOrder, OnFillHnd):
    ...
    def __init__(
        ...
        >>> from saxo_api_client.contrib.orders import StopIfTradedOrder
...
class StopIfTradedOrderCfdOnStock(StopIfTradedOrder):
    ...
    def __init__(
        ...
        >>> from saxo_api_client import API
        >>> import saxo_api_client.endpoints.trading as tr
        >>> from saxo_api_client.contrib.orders import tie_account_to_order, StopIfTradedOrderCfdOnStock
        >>> # create a stop if traded order for AAPL CFD (Uic=211)

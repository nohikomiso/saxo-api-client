...
class GethistoricalpositionsofanaccountofaclientthatwereclosedwithinthespecifiedperiodRequest(_FlexModel):
    ...
    AccountGroupKey: Optional[Any] = Field(default=None, alias="AccountGroupKey", description="Id of the account containing the historical positions.")
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Id of the account containing the historical positions.")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="Filtering on asset type. If value not supplied all will be returned")
    ClientKey: Optional[Any] = Field(default=None, alias="ClientKey", description="Id of the client owning the account")
    FromDate: Optional[str] = Field(default=None, alias="FromDate", description="From date from which the historical positions are requested.")
    MockDataId: Optional[str] = Field(default=None, alias="MockDataId", description="Optional Mock Data Parameter")
    StandardPeriod: Optional[AccountPerformanceStandardPeriod] = Field(default=None, alias="StandardPeriod", description="Standard period for account performance.")
    Symbol: Optional[List[str]] = Field(default=None, alias="Symbol", description="The Instrument Symbol Code")
    ToDate: Optional[str] = Field(default=None, alias="ToDate", description="To date till which the historical positions are requested.")

...
class DocumentType(_FlexModel):
    AnnualFinancialStatement: Optional[Any] = Field(default=None, alias="AnnualFinancialStatement", description="Annual Financial Statement")
    CommercialMemorandum: Optional[Any] = Field(default=None, alias="CommercialMemorandum", description="Commercial Memorandum")
    FactSheet: Optional[Any] = Field(default=None, alias="FactSheet", description="Fact Sheet")
    InvestmentPlan: Optional[Any] = Field(default=None, alias="InvestmentPlan", description="Investment Plan")
    KFS: Optional[Any] = Field(default=None, alias="KFS", description="Key Fact Sheet")
    KIIDs: Optional[Any] = Field(default=None, alias="KIIDs", description="Key Investor Information Document")
    PHS: Optional[Any] = Field(default=None, alias="PHS", description="Product Highlight Sheet")
    PRIIPKIDs: Optional[Any] = Field(default=None, alias="PRIIPKIDs", description="Key Investor Information Document provided by PRIIP (Packaged Retail and Insurance-based Investment Products)")
    Prospectus: Optional[Any] = Field(default=None, alias="Prospectus", description="Prospectus")
    SemiAnnualFinancialStatement: Optional[Any] = Field(default=None, alias="SemiAnnualFinancialStatement", description="Semi Annual Financial Statement")
    SimplifiedProspectus: Optional[Any] = Field(default=None, alias="SimplifiedProspectus", description="Simplified Prospectus")
    TermSheet: Optional[Any] = Field(default=None, alias="TermSheet", description="Term Sheet")

class GetsdocumentrelatedtoinstrumentRequest(_FlexModel):
    Amount: Optional[float] = Field(default=None, alias="Amount", description="")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="AssetType of the instrument.")
    DocumentType: Optional[DocumentType] = Field(default=None, alias="DocumentType", description="DocumentType for which to request information.")
    HoldingPeriodInDays: Optional[int] = Field(default=None, alias="HoldingPeriodInDays", description="")
    LanguageCode: Optional[str] = Field(default=None, alias="LanguageCode", description="LanguageCode for which to request information.")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Uic of the instrument.")

class GetslistofrecommendedinstrumentdocumentinformationRequest(_FlexModel):
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="AssetType of the instrument.")
    DocumentTypes: Optional[List[DocumentType]] = Field(default=None, alias="DocumentTypes", description="The list of document types for which to request information")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Uic of the instrument.")

...
class GetthepricesforunlistedinstrumentsRequest(_FlexModel):
...
class PriceUpdate(_FlexModel):
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="Asset type for instrument")
    Isin: Optional[str] = Field(default=None, alias="Isin", description="Instrument's Isin")
    LastUpdated: Optional[Any] = Field(default=None, alias="LastUpdated", description="Last updated date for instrument")
    Price: Optional[float] = Field(default=None, alias="Price", description="Instrument's price")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Instrument's uic")

class UpdatepricingRequest(_FlexModel):
    PriceUpdates: Optional[List[PriceUpdate]] = Field(default=None, alias="PriceUpdates", description="List of price update")

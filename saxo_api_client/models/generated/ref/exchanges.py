...
class GetallexchangesRequest(_FlexModel):
...
class GetdetailsaboutaspecificexchangeRequest(_FlexModel):
    ExchangeId: Optional[str] = Field(default=None, alias="ExchangeId", description="The ID of the exchange.")

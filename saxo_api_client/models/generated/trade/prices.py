...
class MultiLegPriceFieldGroups(_FlexModel):
    Commissions: Optional[Any] = Field(default=None, alias="Commissions", description="Commission fields are returned in results.")
    DisplayAndFormat: Optional[Any] = Field(default=None, alias="DisplayAndFormat", description="Display and Format (not mapped to a QTE strategy)")
    Greeks: Optional[Any] = Field(default=None, alias="Greeks", description="Greeks are returned in results.")
    InstrumentPriceDetails: Optional[Any] = Field(default=None, alias="InstrumentPriceDetails", description="Fields related to the asset type are returned in results.")
    MarginImpactBuySell: Optional[Any] = Field(default=None, alias="MarginImpactBuySell", description="Margin impact fields are returned in results.")
    Quote: Optional[Any] = Field(default=None, alias="Quote", description="Quote data fields are returned in results.")
...
class MultiLegStrategyLegRequest(_FlexModel):
    ...
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="AssetType.")
    BuySell: Optional[BuySell] = Field(default=None, alias="BuySell", description="Is the option to be bought or sold?")
    ToOpenClose: Optional[ToOpenClose] = Field(default=None, alias="ToOpenClose", description="Whether the margin impact should be calculated as to open/increase or close/decrease a position.")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Instrument identifier for this leg.")

class GetapricesnapshotforamultilegstrategyRequest(_FlexModel):
    ...
    FieldGroups: Optional[List[MultiLegPriceFieldGroups]] = Field(default=None, alias="FieldGroups", description="Specification of fields to return in results")
    Legs: Optional[List[MultiLegStrategyLegRequest]] = Field(default=None, alias="Legs", description="List of each desired legs in a multi-leg order/options strategy.")
...
class CreateapricesubscriptiononamultilegstrategyRequest(_FlexModel):
    Arguments: Optional[MultiLegPriceRequest] = Field(default=None, alias="Arguments", description="Arguments for the subscription request.")
...
class RemoveamultilegpricesubscriptionsRequest(_FlexModel):
...
class RemoveamultilegpricesubscriptionRequest(_FlexModel):
...
class PriceGroupSpec(_FlexModel):
    Commissions: Optional[Any] = Field(default=None, alias="Commissions", description="Commission fields are returned in results.")
    DisplayAndFormat: Optional[Any] = Field(default=None, alias="DisplayAndFormat", description="Display and Format (not mapped to a QTE strategy)")
    Greeks: Optional[Any] = Field(default=None, alias="Greeks", description="Greeks are returned in results.")
    HistoricalChanges: Optional[Any] = Field(default=None, alias="HistoricalChanges", description="Historical price changes are returned in results.")
    InstrumentPriceDetails: Optional[Any] = Field(default=None, alias="InstrumentPriceDetails", description="Fields related to the asset type are returned in results.")
    MarginImpact: Optional[Any] = Field(default=None, alias="MarginImpact", description="(Obsolete) Margin impact fields are returned in results. Will not be available from 1. October 2018, use MarginImpactBuySell instead.")
    MarginImpactBuySell: Optional[Any] = Field(default=None, alias="MarginImpactBuySell", description="Margin impact fields are returned in results.")
    MarketDepth: Optional[Any] = Field(default=None, alias="MarketDepth", description="Market depth fields are returned in results.")
    PriceInfo: Optional[Any] = Field(default=None, alias="PriceInfo", description="Informational price fields are returned in results.")
    PriceInfoDetails: Optional[Any] = Field(default=None, alias="PriceInfoDetails", description="Detailed price fields are returned in results.")
    Quote: Optional[Any] = Field(default=None, alias="Quote", description="Quote data fields are returned in results.")
    Timestamps: Optional[Any] = Field(default=None, alias="Timestamps", description="Price time stamps")

class PriceRequest(_FlexModel):
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Unique key identifying the account used in retrieving the price.")
    Amount: Optional[float] = Field(default=None, alias="Amount", description="Order size, defaults to minimal order size for given instrument.")
    AmountType: Optional[OrderAmountType] = Field(default=None, alias="AmountType", description="")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="The instrument's asset type")
    ContractId_Obsolete: Optional[int] = Field(default=None, alias="ContractId Obsolete", description="Optional. ContractId for trading vanilla or binary fx options.")
    ...
    FieldGroups: Optional[List[PriceGroupSpec]] = Field(default=None, alias="FieldGroups", description="Specification of fields to return in results")
    ForwardDate: Optional[Any] = Field(default=None, alias="ForwardDate", description="Forward date")
    ForwardDateFarLeg: Optional[Any] = Field(default=None, alias="ForwardDateFarLeg", description="Forward date for far leg")
    ForwardDateNearLeg: Optional[Any] = Field(default=None, alias="ForwardDateNearLeg", description="Forward date for near leg")
    OrderAskPrice: Optional[float] = Field(default=None, alias="OrderAskPrice", description="Order ask price. When specified, a corresponding cost of buying will be calculated for that price; otherwise the current market ask price will be used.")
    OrderBidPrice: Optional[float] = Field(default=None, alias="OrderBidPrice", description="Order bid price. When specified, a corresponding cost of selling will be calculated for that price; otherwise the current market bid price will be used.")
    QuoteCurrency: Optional[bool] = Field(default=None, alias="QuoteCurrency", description="")
    RequireTradableQuote_Obsolete: Optional[bool] = Field(default=None, alias="RequireTradableQuote Obsolete", description="Optional argument to require that the subscription returns tradable quotes i.e. provides a quoteId. The value defaults to false.")
    SharePrice: Optional[float] = Field(default=None, alias="SharePrice", description="Share Price. Used when subscribing on a price when placing an order for CFDs. When provided it may lead to EstPriceSell / EstPriceBuy being returned in the InstrumentPriceDetail. Not relevant for info prices.")
    StrategyName: Optional[str] = Field(default=None, alias="StrategyName", description="Optional argument to specify an algo-order strategy")
    ToClosePositionId: Optional[int] = Field(default=None, alias="ToClosePositionId", description="Set this if the intention is that the subsequent trade should close the position with the specified position id.")
    ToOpenClose: Optional[ToOpenClose] = Field(default=None, alias="ToOpenClose", description="")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Unique id of the instrument")

class CreateapricesubscriptiononaninstrumentRequest(_FlexModel):
    Arguments: Optional[PriceRequest] = Field(default=None, alias="Arguments", description="Arguments for the subscription request.")
    ContextId: Optional[str] = Field(default=None, alias="ContextId", description="The streaming context id that this request is associated with. This parameter must only contain letters (a-z) and numbers (0-9) as well as - (dash) and _ (underscore). It is case insensitive. Max length is 50 characters.")
    Format: Optional[str] = Field(default=None, alias="Format", description="Optional Media type (RFC 2046) of the serialized data updates that are streamed to the client. Currently only application/json and application/x-protobuf is supported. If an unrecognized format is specified, the subscription end point will return HTTP status code 400 - Bad format.")
    ReferenceId: Optional[str] = Field(default=None, alias="ReferenceId", description="Mandatory client specified reference id for the subscription. This parameter must only contain alphanumberic characters as well as - (dash) and _ (underscore). Cannot start with _. It is case insensitive. Max length is 50 characters.")
    RefreshRate: Optional[int] = Field(default=None, alias="RefreshRate", description="Optional custom refresh rate, measured in milliseconds, between each data update. Note that it is not possible to get a refresh rate lower than the rate specified in the customer service level agreement (SLA).")
...
class RemovemultipleinstrumentpricesubscriptionsRequest(_FlexModel):
    ContextId: Optional[str] = Field(default=None, alias="ContextId", description="The context id part of the streaming session (used to identify the subscription within a streaming session).")
    Tag: Optional[str] = Field(default=None, alias="Tag", description="Optional.Tag that subscriptions are marked with.")

class RemoveaninstrumentpricesubscriptionRequest(_FlexModel):
    ContextId: Optional[str] = Field(default=None, alias="ContextId", description="Unique streaming context ID part of the streaming session.")
    ReferenceId: Optional[str] = Field(default=None, alias="ReferenceId", description="Unique reference ID of the subscription.")

class RequestmarginimpactononepriceupdateRequest(_FlexModel):
    ContextId: Optional[str] = Field(default=None, alias="ContextId", description="Context for the streaming connection.")

...
class PriceAlertDefinitionState(_FlexModel):
    Disabled: Optional[Any] = Field(default=None, alias="Disabled", description="The price alert is disabled and does not cause notifications to be triggered.")
    Enabled: Optional[Any] = Field(default=None, alias="Enabled", description="The price alert is enabled and thus may cause notifications to be triggered.")
    RecentlyTriggered: Optional[Any] = Field(default=None, alias="RecentlyTriggered", description="The price alert is an enabled, recurring alert that was recently triggered, and thus it will not be triggered again right away.")

class GetallpricealertdefinitionsRequest(_FlexModel):
    ...
    State: Optional[PriceAlertDefinitionState] = Field(default=None, alias="State", description="Optional state the price alert definitions should match. The values must be one of PriceAlertDefinitionState. The match is case insensitive.")
...
class PriceAlertComparisonOperator(_FlexModel):
    GreaterOrEqual: Optional[Any] = Field(default=None, alias="GreaterOrEqual", description="The price is greater than or equal to (>=) the value specified in the alert definition.")
    LessOrEqual: Optional[Any] = Field(default=None, alias="LessOrEqual", description="The price is less than or equal to (<=) the value specified in the alert definition.")

class PriceVariable(_FlexModel):
    AskTick: Optional[Any] = Field(default=None, alias="AskTick", description="Ask price tick.")
    BidTick: Optional[Any] = Field(default=None, alias="BidTick", description="Bid price tick.")
    PercentChange: Optional[Any] = Field(default=None, alias="PercentChange", description="Percentage change from last close value.")
    Traded: Optional[Any] = Field(default=None, alias="Traded", description="Traded price.")

class CreateapricealertdefinitionRequest(_FlexModel):
    AccountId: Optional[str] = Field(default=None, alias="AccountId", description="The account that owns this price alert definition.")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="The type of instrument that this alert is monitoring.")
    Comment: Optional[str] = Field(default=None, alias="Comment", description="An optional comment associated with the price alert definition. The maximum supported length of the string is 128 characters.")
    ExpiryDate: Optional[Any] = Field(default=None, alias="ExpiryDate", description="The UTC date and time that the price alert definition will expire and then be removed from the system. The date and time is specified in Coordinated Universal Time (UTC) and should be formatted as 'yyyy-mm-ddThh:mm:ssZ'.")
    IsExtendedHours: Optional[bool] = Field(default=None, alias="IsExtendedHours", description="An optional flag to indicate if price alert definition is valid in extended hours trading. Default will be set to false.")
    IsRecurring: Optional[bool] = Field(default=None, alias="IsRecurring", description="Is the alert only triggered once or will the alerts keep recurring until the alert expires.")
    Operator: Optional[PriceAlertComparisonOperator] = Field(default=None, alias="Operator", description="The boolean operator used to compare the current price with the defined value.")
    PriceVariable: Optional[PriceVariable] = Field(default=None, alias="PriceVariable", description="The aspect of the price that is being monitored.")
    State: Optional[PriceAlertDefinitionState] = Field(default=None, alias="State", description="A price alert definition can be enabled, disabled or suspended. RecentlyTriggered is used for recurring alerts, so that they don't trigger constantly once the condition has been met.")
    TargetValue: Optional[float] = Field(default=None, alias="TargetValue", description="The value that the current price is compared to.")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Universal Instrument Code (UIC).")

class GetapricealertdefinitionRequest(_FlexModel):
    AlertDefinitionId: Optional[int] = Field(default=None, alias="AlertDefinitionId", description="The id of the price alert definition.")

class UpdateapricealertdefinitionRequest(_FlexModel):
    AccountId: Optional[str] = Field(default=None, alias="AccountId", description="The account that owns this price alert definition.")
    AlertDefinitionId: Optional[int] = Field(default=None, alias="AlertDefinitionId", description="Alert definition id to update.")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="The type of instrument that this alert is monitoring.")
    Comment: Optional[str] = Field(default=None, alias="Comment", description="An optional comment associated with the price alert definition. The maximum supported length of the string is 128 characters.")
    ExpiryDate: Optional[Any] = Field(default=None, alias="ExpiryDate", description="The UTC date and time that the price alert definition will expire and then be removed from the system. The date and time is specified in Coordinated Universal Time (UTC) and should be formatted as 'yyyy-mm-ddThh:mm:ssZ'.")
    IsExtendedHours: Optional[bool] = Field(default=None, alias="IsExtendedHours", description="An optional flag to indicate if price alert definition is valid in extended hours trading. Default will be set to false.")
...
class DeletepricealertdefinitionsRequest(_FlexModel):
    AlertDefinitionIds: Optional[str] = Field(default=None, alias="AlertDefinitionIds", description="A comma separated list of the price alert definition Ids to delete.")

class AlertSound(_FlexModel):
    Asterisk: Optional[Any] = Field(default=None, alias="Asterisk", description="Asterisk sound.")
    Beep: Optional[Any] = Field(default=None, alias="Beep", description="Beep sound.")
    Exclamation: Optional[Any] = Field(default=None, alias="Exclamation", description="Exclamation sound.")
    Hand: Optional[Any] = Field(default=None, alias="Hand", description="Hand sound.")
    None_: Optional[Any] = Field(default=None, alias="None", description="No sound.")
    Question: Optional[Any] = Field(default=None, alias="Question", description="Question sound.")

class GetnotificationsettingsRequest(_FlexModel):
    EmailAddress: Optional[str] = Field(default=None, alias="EmailAddress", description="The email address to send alert notifications to.")
    EmailAddressValidated: Optional[bool] = Field(default=None, alias="EmailAddressValidated", description="Set to true if the email address has been validated.")
    NotifyWithMail: Optional[bool] = Field(default=None, alias="NotifyWithMail", description="Send an email when a notification is triggered.")
    NotifyWithPopup: Optional[bool] = Field(default=None, alias="NotifyWithPopup", description="Show triggered notifications with pop-ups.")
    Sound: Optional[AlertSound] = Field(default=None, alias="Sound", description="The sound to play when showing a popup notification.")

class UpdatenotificationsettingsRequest(_FlexModel):
    EmailAddress: Optional[str] = Field(default=None, alias="EmailAddress", description="The email address to send alert notifications to.")
    NotifyWithMail: Optional[bool] = Field(default=None, alias="NotifyWithMail", description="Send an email when a notification is triggered.")
    NotifyWithPopup: Optional[bool] = Field(default=None, alias="NotifyWithPopup", description="Show triggered notifications with pop-ups.")
    Sound: Optional[AlertSound] = Field(default=None, alias="Sound", description="The sound to play when showing a popup notification.")

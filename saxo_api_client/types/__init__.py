...
```python
from saxo_api_client.types import Uic, ClientKey, BalanceResponse
...
from saxo_api_client.types.primitives import (
    AccountKey,
    AssetType,
    ClientKey,
    OrderId,
...
from saxo_api_client.types.responses import (
    BalanceResponse,
    OrderResponse,

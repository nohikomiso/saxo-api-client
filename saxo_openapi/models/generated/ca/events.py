...
class GetcorporateactioneventsRequest(_FlexModel):
    ...
    AccountGroupKey: Optional[Any] = Field(default=None, alias="AccountGroupKey", description="Account group to get the events for.")
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Account to get the events for.")
    AssetTypes: Optional[List[AssetType]] = Field(default=None, alias="AssetTypes", description="Asset type filter for events.")
    ClientKey: Optional[Any] = Field(default=None, alias="ClientKey", description="Client to get the events for.")
...
class GetcorporateactioneventRequest(_FlexModel):
    ...
    EventId: Optional[str] = Field(default=None, alias="EventId", description="Corporate action identifier")
    EventStates: Optional[List[EventState]] = Field(default=None, alias="EventStates", description="Specify event states to look into for event. If EventStates are not specified in request then event will be looked into data from EventStates Approved,Confirmed,Preliminary and Withdrawn.")
    IncludeSubAccounts: Optional[bool] = Field(default=None, alias="IncludeSubAccounts", description="Indicate whether to include events from sub-clients.")

class LookupFieldGroups(_FlexModel):
    All: Optional[Any] = Field(default=None, alias="All", description="Specifies that all the lookups will be available in the response.")
    AllAssetTypes: Optional[Any] = Field(default=None, alias="AllAssetTypes", description="Includes all available AssetTypes in response.")
    AllEventTypes: Optional[Any] = Field(default=None, alias="AllEventTypes", description="Includes all available EventTypes in response.")
    AssetTypes: Optional[Any] = Field(default=None, alias="AssetTypes", description="Includes only relevant AssetTypes in response.")
    EventTypes: Optional[Any] = Field(default=None, alias="EventTypes", description="Includes only relevant EventTypes in response.")

class LookupforfiltersRequest(_FlexModel):
    AccountGroupKey: Optional[Any] = Field(default=None, alias="AccountGroupKey", description="Account group to get the events for.")
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Account to get the events for.")
    ClientKey: Optional[Any] = Field(default=None, alias="ClientKey", description="Client to get the events for.")
    FieldGroups: Optional[LookupFieldGroups] = Field(default=None, alias="FieldGroups", description="Specify lookup fields required in response. If FieldGroups are not specified in request then response will only contain data from FieldGroups with relevant data.")
    IncludeSubAccounts: Optional[bool] = Field(default=None, alias="IncludeSubAccounts", description="Indicate whether to include events from sub-clients.")

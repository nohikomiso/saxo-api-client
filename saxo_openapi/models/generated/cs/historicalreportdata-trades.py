...
class GetsalltradesfordatesortradeIdRequest(_FlexModel):
    ...
    FromDate: Optional[str] = Field(default=None, alias="FromDate", description="from date in UTC, ignored when tradeId is given")
    MockDataId: Optional[str] = Field(default=None, alias="MockDataId", description="Optional Mock Data Parameter")
    ToDate: Optional[str] = Field(default=None, alias="ToDate", description="to date in UTC, ignored when tradeId is given")
    TradeId: Optional[str] = Field(default=None, alias="TradeId", description="trade id, accountkey is mandatory with tradeId")

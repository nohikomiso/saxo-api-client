...
class GetacurrencyexposureslistforaclientaccountGrouporaccountRequest(_FlexModel):
...
class CurrencyExposuresResponse(_FlexModel):
    Amount: Optional[float] = Field(default=None, alias="Amount", description="Total exposure in the given currency.")
    AmountInCalculationEntityCurrency: Optional[float] = Field(default=None, alias="AmountInCalculationEntityCurrency", description="Total exposure in the currency of the calculation entity.")
    Currency: Optional[str] = Field(default=None, alias="Currency", description="The exposure currency.")

class GetacurrencyexposureslistforaclientaccountGrouporaccountResponse(_FlexModel):
    ...
    Data: Optional[List[CurrencyExposuresResponse]] = Field(default=None, alias="Data", description="The collection of entities for this feed.")
...
class GetcurrencyexposuresforaclienttowhichtheloggedinuserbelongsResponse(_FlexModel):
    count: Optional[float] = Field(default=None, alias="__count", description="The total count of items in the feed.")
    next: Optional[str] = Field(default=None, alias="__next", description="The link for the next page of items in the feed.")
    Data: Optional[List[CurrencyExposuresResponse]] = Field(default=None, alias="Data", description="The collection of entities for this feed.")
    MaxRows: Optional[float] = Field(default=None, alias="MaxRows", description="The maximum number of rows that can be returned (if applicable).")

class GetnetFxSpotexposureslistforaclientaccountGrouporaccountRequest(_FlexModel):
    AccountGroupKey: Optional[Any] = Field(default=None, alias="AccountGroupKey", description="The key of the account group to which the positions belong.")
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="The key of the account to which the positions belong.")
    ClientKey: Optional[Any] = Field(default=None, alias="ClientKey", description="The key of the client to which the positions belong.")
    StrategyGroupingEnabled: Optional[bool] = Field(default=None, alias="StrategyGroupingEnabled", description="Specifies if the positions should be grouped by strategy. Default is false")

class GetnetFxSpotexposureslistforaclientaccountGrouporaccountResponse(_FlexModel):
    count: Optional[float] = Field(default=None, alias="__count", description="The total count of items in the feed.")
    next: Optional[str] = Field(default=None, alias="__next", description="The link for the next page of items in the feed.")
    Data: Optional[List[CurrencyExposuresResponse]] = Field(default=None, alias="Data", description="The collection of entities for this feed.")
    MaxRows: Optional[float] = Field(default=None, alias="MaxRows", description="The maximum number of rows that can be returned (if applicable).")

class GetnetFxSpotexposuresforaclienttowhichtheloggedinuserbelongsResponse(_FlexModel):
    count: Optional[float] = Field(default=None, alias="__count", description="The total count of items in the feed.")
    next: Optional[str] = Field(default=None, alias="__next", description="The link for the next page of items in the feed.")
    Data: Optional[List[CurrencyExposuresResponse]] = Field(default=None, alias="Data", description="The collection of entities for this feed.")
    MaxRows: Optional[float] = Field(default=None, alias="MaxRows", description="The maximum number of rows that can be returned (if applicable).")
...
class GetinstrumentnetexposurelistforaclientaccountGrouporaccountRequest(_FlexModel):
    AccountGroupKey: Optional[Any] = Field(default=None, alias="AccountGroupKey", description="The key of the account group to which the positions belong.")
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="The key of the account to which the positions belong.")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="The AssetType.")
    ClientKey: Optional[Any] = Field(default=None, alias="ClientKey", description="The key of the client to which the positions belong.")
    ExpiryDate: Optional[Any] = Field(default=None, alias="ExpiryDate", description="The expiry date. Only used to distinguish FxOptions.")
    LowerBarrier: Optional[float] = Field(default=None, alias="LowerBarrier", description="The Lower Barrier. Only used to distinguish Fx Barrier Options.")
    PutCall: Optional[PutCall] = Field(default=None, alias="PutCall", description="Put or Call. Only used to distinguish FxOptions.")
    StrategyGroupingEnabled: Optional[bool] = Field(default=None, alias="StrategyGroupingEnabled", description="Specifies if the positions should be grouped by strategy. Default is false")
    Strike: Optional[float] = Field(default=None, alias="Strike", description="The strike price of the option. Only used to distinguish FxOptions.")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Unique id of the instrument.")
    UpperBarrier: Optional[float] = Field(default=None, alias="UpperBarrier", description="The Upper Barrier. Only used to distinguish Fx Barrier Options.")
    ValueDate: Optional[Any] = Field(default=None, alias="ValueDate", description="The value date. Only used to distinguish FxForwards.")
...
class InstrumentExposureResponse(_FlexModel):
    Amount: Optional[float] = Field(default=None, alias="Amount", description="Sum exposure of positions in instrument")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="The AssetType.")
    AverageOpenPrice: Optional[float] = Field(default=None, alias="AverageOpenPrice", description="The average price of all the positions that make up the exposure.")
    CalculationReliability: Optional[CalculationReliability] = Field(default=None, alias="CalculationReliability", description="If an error was encountered this code indicates source of the calculation error.")
    CanBeClosed: Optional[bool] = Field(default=None, alias="CanBeClosed", description="Indicates if the exposure may be closed.")
    ...
    NetPositionId: Optional[str] = Field(default=None, alias="NetPositionId", description="The exposure net position id. May be used to fetch the net position or open positions of the net position from the Open Positions service.")
...
class GetinstrumentnetexposurelistforaclientaccountGrouporaccountResponse(_FlexModel):
    count: Optional[float] = Field(default=None, alias="__count", description="The total count of items in the feed.")
    next: Optional[str] = Field(default=None, alias="__next", description="The link for the next page of items in the feed.")
    Data: Optional[List[InstrumentExposureResponse]] = Field(default=None, alias="Data", description="The collection of entities for this feed.")
    MaxRows: Optional[float] = Field(default=None, alias="MaxRows", description="The maximum number of rows that can be returned (if applicable).")

class GetthenetinstrumentexposureforaclienttowhichtheloggedinuserbelongsResponse(_FlexModel):
    count: Optional[float] = Field(default=None, alias="__count", description="The total count of items in the feed.")
    next: Optional[str] = Field(default=None, alias="__next", description="The link for the next page of items in the feed.")
    Data: Optional[List[InstrumentExposureResponse]] = Field(default=None, alias="Data", description="The collection of entities for this feed.")
    MaxRows: Optional[float] = Field(default=None, alias="MaxRows", description="The maximum number of rows that can be returned (if applicable).")
...
class CreateasubscriptiononalistofinstrumentexposureandmakeitactiveRequest(_FlexModel):
    Arguments: Optional[InstrumentExposureRequest] = Field(default=None, alias="Arguments", description="Arguments for the subscription request.")
...
class CreateasubscriptiononalistofinstrumentexposureandmakeitactiveResponse(_FlexModel):
    ...
    Snapshot: Optional[InstrumentExposureResponseListResult] = Field(default=None, alias="Snapshot", description="Snapshot of the current data on hand, when subscription was created.")

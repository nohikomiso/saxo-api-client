...
class GetallstrategiessupportedbySaxoBankRequest(_FlexModel):
...
class GetdetailsaboutaspecificstrategyRequest(_FlexModel):
    Name: Optional[str] = Field(default=None, alias="Name", description="The name of the Strategy.")

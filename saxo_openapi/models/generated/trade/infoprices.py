...
class InfoPriceGroupSpec(_FlexModel):
    ...
    Greeks: Optional[Any] = Field(default=None, alias="Greeks", description="")
    ...
    InstrumentPriceDetails: Optional[Any] = Field(default=None, alias="InstrumentPriceDetails", description="Fields related to the asset type are returned in results. Fields in this group are only returned when issuing a GET and in the initial snapshot if setting up a subscription.")
...
class GetaninfopriceforaspecificinstrumentRequest(_FlexModel):
    ...
    FieldGroups: Optional[List[InfoPriceGroupSpec]] = Field(default=None, alias="FieldGroups", description="Specification of fields to return in results")
    ...
    OrderAskPrice: Optional[float] = Field(default=None, alias="OrderAskPrice", description="Price when buying. Used when subscribing on a price to get a corresponsing cost of buying.")
    OrderBidPrice: Optional[float] = Field(default=None, alias="OrderBidPrice", description="Price when selling. Used when subscribing on a price to get a corresponsing cost of buying.")
...
class GetinfopricesforalistofinstrumentsRequest(_FlexModel):
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Unique key identifying the account used in retrieving the infoprice. Only required when calling context represents an authenticated user. If not supplied a default account is assumed.")
    Amount: Optional[float] = Field(default=None, alias="Amount", description="Order size, defaults to minimal order size for given instrument.")
    AmountType: Optional[OrderAmountType] = Field(default=None, alias="AmountType", description="")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="The instrument's asset type")
    FieldGroups: Optional[List[InfoPriceGroupSpec]] = Field(default=None, alias="FieldGroups", description="Specification of field groups to return in results. Default is 'Quote'")
    ForwardDate: Optional[Any] = Field(default=None, alias="ForwardDate", description="Forward date")
    ForwardDateFarLeg: Optional[Any] = Field(default=None, alias="ForwardDateFarLeg", description="Forward date for far leg")
    ForwardDateNearLeg: Optional[Any] = Field(default=None, alias="ForwardDateNearLeg", description="Forward date for near leg")
    ...
    QuoteCurrency: Optional[bool] = Field(default=None, alias="QuoteCurrency", description="")
    ToOpenClose: Optional[ToOpenClose] = Field(default=None, alias="ToOpenClose", description="")
    Uics: Optional[str] = Field(default=None, alias="Uics", description="A comma separated list of Uics.")
...
class CreateanactiveinfopricesubscriptiononanlistofinstrumentsRequest(_FlexModel):
    Arguments: Optional[InfoPriceListRequest] = Field(default=None, alias="Arguments", description="Arguments for the subscription request.")
...
class RemoveinfopricesubscriptionsoninstrumentsRequest(_FlexModel):
...
class RemoveinfopricesubscriptiononaninstrumentRequest(_FlexModel):

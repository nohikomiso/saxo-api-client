...
class ExerciseMethod(_FlexModel):
    Cash: Optional[Any] = Field(default=None, alias="Cash", description="Option P/L is converted to cash.")
    Spot: Optional[Any] = Field(default=None, alias="Spot", description="Option is converted to spot position.")

class UpdateapositionRequest(_FlexModel):
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Gets or sets the account key.")
    DisableForceOpen: Optional[bool] = Field(default=None, alias="DisableForceOpen", description="If set True, it clears the force open flag from position which allows default netting automatically from the opposite direction")
    ExerciseMethod_Obsolete: Optional[ExerciseMethod] = Field(default=None, alias="ExerciseMethod Obsolete", description="Exercise method for FX Options, This is only relevant for FX Options, where you can update the Exercise method.")
    PositionId: Optional[str] = Field(default=None, alias="PositionId", description="The position identifier.")
...
class ExerciseapositionRequest(_FlexModel):
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Gets or sets the account identifier.")
    Amount: Optional[int] = Field(default=None, alias="Amount", description="Number of Lots to be exercised")
    ...
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="Gets or sets the type of the asset.")
    PositionId: Optional[str] = Field(default=None, alias="PositionId", description="The position identifier.")
    Uic: Optional[int] = Field(default=None, alias="Uic", description="Gets or sets the uic.")

class ExerciseanamountRequest(_FlexModel):
    AccountKey: Optional[Any] = Field(default=None, alias="AccountKey", description="Gets or sets the account identifier.")
    Amount: Optional[int] = Field(default=None, alias="Amount", description="Number of Lots to be exercised")
    AppHint: Optional[int] = Field(default=None, alias="AppHint", description="Optional informational id, which will be added to the order for statistics purposes. Only relevant for Saxo applications")
    AssetType: Optional[AssetType] = Field(default=None, alias="AssetType", description="Gets or sets the type of the asset.")
